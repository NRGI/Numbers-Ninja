...
There a two things we need to do before we start the lesson.
...
3. Install the following package - tidyverse, wbstats and nycflights13 using Rstudio
...
We will be using the `nycflights13` package for this section.
