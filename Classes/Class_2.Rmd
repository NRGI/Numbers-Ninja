...
```{r, echo=FALSE}
knitr::include_graphics("assets/ian-dooley-407846-unsplash.jpg")
```
...
While we Please keep [this](https://ggplot2.tidyverse.org/reference/) reference website open through out the call. We will be using the the `tidyverse` and `gapminder` packages. Make sure that you create a chunk at the top of your notebook to load these two packages.
