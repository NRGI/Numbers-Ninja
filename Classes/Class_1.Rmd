...
R Markdown combine markdown with R code. You can think of markdown as a human readable version of HTML that is suitable for producing content heavy websites like blogs. Using R Markdown we can insert "code chunks" that 
...
2. Install the following package - `tidyverse` and `nycflights13` packages using Rstudio
